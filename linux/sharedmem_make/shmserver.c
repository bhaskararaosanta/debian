...
int main()
{
	...
	if((shmaddrserver = (struct shmbuf *)shmat(shmid, NULL, 0)) == (struct shmbuf *) -1) {
		perror("shmat");
		exit(EXIT_FAILURE);
	}
	...
	shmaddrserver->data = 100;
	strcpy(shmaddrserver->message, "Embedded is great");
